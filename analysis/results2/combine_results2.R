...
train_results2 <- read.csv("analysis/results2/train_results2.csv")
...
train_results2_125 <- read.csv("analysis/results2/train_results2_125.csv")
test_results2_125 <- read.csv("analysis/results2/test_results2_125.csv")

train_results2_2 <- read.csv("analysis/results2/train_results2_2.csv")
test_results2_2 <- read.csv("analysis/results2/test_results2_2.csv")

train_results3_125 <- read.csv("analysis/results2/train_results3_125.csv")
test_results3_125 <- read.csv("analysis/results2/test_results3_125.csv")

train_results3_2 <- read.csv("analysis/results2/train_results3_2.csv")
test_results3_2 <- read.csv("analysis/results2/test_results3_2.csv")

train_results2_5 <- read.csv("analysis/results2/train_results2_5.csv")
test_results2_5 <- read.csv("analysis/results2/test_results2_5.csv")

train_results3_5 <- read.csv("analysis/results2/train_results3_5.csv")
test_results3_5 <- read.csv("analysis/results2/test_results3_5.csv")
...
results %>% view()
results %>% 
  filter(method == "svm_fair_test2 1.25" |
           method == "svm_fair_test2 5" |
           method == "svm_fair_test2 2" |
           method == "svm_fair_test2")
...
results_subset %>% write.csv("analysis/results_subset2.csv")
